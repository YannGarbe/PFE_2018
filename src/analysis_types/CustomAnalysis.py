...
class CustomAnalysis:
    ...
    def analyse_data(self, dict_data, filespath, moreThan, lessThan, equalsTo, get_all):
        tools = AnalysisTools()
                ...
                for strand in dict_data[id_a][id_b]:
                    ...
                    if len(intervals) > 1:
                        ...
                        if moreThan is not None:
                            list_id_A = tools.retrieve_id_more_analysis(int(moreThan), cover_A, list_id_A)
                            list_id_B = tools.retrieve_id_more_analysis(int(moreThan), cover_B, list_id_B)
                        elif lessThan is not None:
                            list_id_A = tools.retrieve_id_less_analysis(int(lessThan), cover_A, list_id_A)
                            list_id_B = tools.retrieve_id_less_analysis(int(lessThan), cover_B, list_id_B)
                        else:
                            list_id_A = tools.retrieve_id_equals_analysis(int(equalsTo), cover_A, list_id_A)
                            list_id_B = tools.retrieve_id_equals_analysis(int(equalsTo), cover_B, list_id_B)
